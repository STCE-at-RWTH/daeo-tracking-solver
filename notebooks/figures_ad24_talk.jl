...
# ╔═╡ 521e6b48-71c9-11ef-16dd-3f17ca86008b
begin
	using LaTeXStrings
	using LinearAlgebra
	using Plots
...
fig1 = begin
	...
	scatter!(p1, min_ys, min_hs, label=L"\left.y_k\right|_{x=0}", ms=12, msw=3, marker=:x)
	scatter!(p1, min_y2s, min_h2s, label=L"\left.y_k\right|_{x=3}", ms=12, msw=3, marker=:x)
	p1
end

# ╔═╡ 70335998-b7cc-4d4f-9e43-2b9a5223a637
savefig(fig1, "../gfx/minima_shifting.pdf")
